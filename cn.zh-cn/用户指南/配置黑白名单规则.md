...
5.  在弹出的对话框中，添加黑白名单规则，如[图3](#fig16699125187)所示，参数说明如[表1](#table147241231818)所示。
    ...
    **表 1**  黑白名单参数说明
    ...
    <div class="notice" id="note3522103392412"><a name="note3522103392412"></a><a name="note3522103392412"></a><span class="noticetitle"> 须知： </span><div class="noticebody"><p id="zh-cn_topic_0110861354_p9994853161215"><a name="zh-cn_topic_0110861354_p9994853161215"></a><a name="zh-cn_topic_0110861354_p9994853161215"></a>仅企业版和旗舰版支持IPv6。</p>
    </div></div>
    </td>
