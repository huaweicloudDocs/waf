...
-   如果客户端爬虫伪造了WAF的认证请求，JS验证失败，WAF将拦截该请求。

通过统计“JS挑战”和“JS验证”，就可以汇总出JS脚本反爬虫防御的请求次数。例如，[图2](#fig10806185634312)中JS脚本反爬虫共防御了24次请求，其中，“JS挑战”23次（爬虫访问），防御“JS验证”1次（爬虫伪造WAF认证请求）。
...
2.  进入防护策略配置入口，如[图3](#zh-cn_topic_0110861309_fig089771664710)所示。

    **图 3**  防护策略配置入口<a name="zh-cn_topic_0110861309_fig089771664710"></a>  
...
2.  参照[配置精准访问防护规则](zh-cn_topic_0110861295.md)配置如[图8](#fig1439052051516)的规则。
