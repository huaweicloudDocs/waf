...
7.  选择“防护配置“页签，根据您的业务场景，开启合适的防护功能，检测项说明如[表2](#table1054818371898)所示。

    **图 1**  Web基础防护<a name="fig17347539113910"></a>  
    ![](figures/Web基础防护.png "Web基础防护")

    1.  防护动作设置。
        -   拦截：发现攻击行为后立即阻断并记录。

            设置为“拦截“时，您可以根据需要选择已配置的攻击惩罚。有关配置攻击惩罚的详细操作，请参见[配置攻击惩罚标准自动封禁访问者指定时长](配置攻击惩罚标准自动封禁访问者指定时长.md)。
...
8.  选择“防护规则“页签，查看Web基础防护规则的详细信息，如[图2](#fig8837434185019)所示，相关参数说明如[表3](#table19135226105218)所示。

    **图 2**  查看防护规则<a name="fig8837434185019"></a>  
...
1.  开启Web基础防护的“常规检测“，并将防护模式设置为“拦截“。
    ...
    **图 3**  开启“常规检测“<a name="fig11294730881"></a>  
    ![](figures/开启常规检测.png "开启常规检测")

2.  开启Web基础防护。

    **图 4**  Web基础防护配置框<a name="fig845094155618"></a>  
    ![](figures/Web基础防护配置框.png "Web基础防护配置框")

3.  清理浏览器缓存，在浏览器中输入模拟SQL注入攻击（例如，http://www.example.com?id=' or 1=1）。

    WAF将拦截该访问请求，拦截页面示例如[图5](#fig4672124158)所示。

    **图 5**  WAF拦截攻击请求<a name="fig4672124158"></a>  
