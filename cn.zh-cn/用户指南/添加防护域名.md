...
6.  选择“是否已使用代理“，默认为“否“。
    ...
    >-   如果网站未使用任何代理，而“是否已使用代理“选择了“是“，该配置仅会使WAF在获取真实源IP时信任HTTP请求头中的X-Forwarded-For字段，不影响用户业务。
