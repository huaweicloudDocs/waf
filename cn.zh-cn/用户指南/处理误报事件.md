...
3.  选择“查询“页签，在网站或实例下拉列表中选择待查看的防护网站或实例，可查看“昨天“、“今天“、“3天““7天“、“30天“或者自定义时间范围内的防护日志，如[图2](#fig194311743164914)所示，参数说明如[表1](#table146358613417)和[表2](#table135241210519)所示。
    ...
    **表 2**  日志列表参数说明
    ...
    <td class="cellrowborder" valign="top" width="50.29%" headers="mcps1.2.3.1.2 "><p id="p15478124512461"><a name="p15478124512461"></a><a name="p15478124512461"></a>本次攻击对防护域名造成伤害的位置或组成部分。</p>
    ...
    <td class="cellrowborder" valign="top" width="50.29%" headers="mcps1.2.3.1.2 "><p id="p556853615117"><a name="p556853615117"></a><a name="p556853615117"></a>防护配置中设置的防护动作，包含：拦截、仅记录、人机验证、放行和过滤。</p>
    </td>
    </tr>
    </tbody>
    </table>
