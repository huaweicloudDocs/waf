...
4.  当攻击事件属于误报时，在该攻击事件所在行的“操作“列，单击“误报处理“，添加误报屏蔽策略，如[图3](#fig16174064111318)所示，参数说明如[表3](#table1326514293541)所示。
    ...
    **表 3**  误报处理参数说明
    ...
    <a name="ul52161845421"></a><a name="ul52161845421"></a><ul id="ul52161845421"><li>按ID：按攻击命中规则的ID进行配置。</li><li>按类别：按攻击事件类别进行配置。</li><li>所有内置规则：<a href="配置Web基础防护规则.md">Web基础防护规则</a>里开启的所有防护规则。</li></ul>
    </td>
    ...
    <p id="p1273401125912"><a name="p1273401125912"></a><a name="p1273401125912"></a>自动读取的内置规则的命中规则ID。</p>
    </td>
