...
2.  手动模拟简单的web攻击命令，测试Web攻击请求。
    ...
    2.  清理浏览器缓存，在浏览器中输入“http://www.example5.com?id=1%20or%201%20=1“模拟SQL注入攻击，测试WAF是否拦截了此条攻击，如[图5](#fig1471040175918)所示。

        **图 5**  访问被拦截<a name="fig1471040175918"></a>  
        ![](figures/访问被拦截.png "访问被拦截")

    3.  可通过“安全  \>  Web应用防火墙“ ，单击“防护事件“，进入“防护事件“页面，查看防护域名测试的各项数据，如[图6](#fig1348440105913)所示。

        **图 6**  查看测试数据<a name="fig1348440105913"></a>  
