...
2.  单击管理控制台左上角的![](figures/icon-region-41.jpg)，选择区域或项目。
3.  单击页面左上方的![](figures/icon-Service-42.png)，选择“安全与合规  \>  Web应用防火墙 WAF“。
4.  在左侧导航树中，选择“防护策略“，进入“防护策略“页面。
5.  单击目标策略名称，进入目标策略的防护配置页面。
6.  <a name="li11722104461314"></a>在“网站反爬虫“配置框中，用户可根据自己的需要更改网站反爬虫的“状态“，单击“BOT设置“，进入网站反爬虫规则配置页面。

    **图 3**  网站反爬虫配置框<a name="fig193788379"></a>  
    ![](figures/网站反爬虫配置框.png "网站反爬虫配置框")

7.  选择“特征反爬虫“页签，根据您的业务场景，开启合适的防护功能，如[图4](#fig127337271541)所示，检测项说明如[表1](#table173611272418)所示。
    ...
    **图 4**  特征反爬虫防护<a name="fig127337271541"></a>  
...
9.  根据业务配置JS脚本反爬虫规则，相关参数说明如[表2](#table158689225415)所示。
    ...
    -   除了指定请求规则以外，防护其他所有请求
        ...
        **图 5**  添加排除防护路径<a name="fig151791517162220"></a>  
    ...
    -   只防护指定请求时
        ...
        **图 6**  添加请求规则<a name="fig1312693317407"></a>  
...
2.  在“特征反爬虫“页签，开启“脚本工具“，“防护动作“设置为“仅记录“（WAF检测为攻击行为后，只记录不阻断）。
    ...
    **图 7**  开启“脚本工具“<a name="fig6861311122610"></a>  
    ![](figures/开启脚本工具.png "开启脚本工具")

3.  开启网站反爬虫。

    **图 8**  网站反爬虫配置框<a name="fig573761514274"></a>  
    ![](figures/网站反爬虫配置框.png "网站反爬虫配置框")

4.  在左侧导航树中，单击“防护事件“，进入“防护事件“页面，您可以查看该防护事件。

    **图 9**  查看防护事件-脚本爬虫<a name="fig6322145644618"></a>  
...
1.  参照[6](#li11722104461314)将“搜索引擎“设置为放行，即将“搜索引擎“的“状态“设置为![](figures/icon-disable-43.png)。
2.  参照[配置精准访问防护规则定制化防护策略](配置精准访问防护规则定制化防护策略.md)配置如[图10](#fig1439052051516)的规则。

    **图 10**  拦截POST请求<a name="fig1439052051516"></a>  
