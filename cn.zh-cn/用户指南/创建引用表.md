...
1.  在“精准访问防护“配置框中，设置“状态“为开启状态![](figures/开启图标-11.png)，单击“自定义精准访问防护规则“，进入精准访问防护规则配置页面，如[图2](#waf_01_0010_fig275911394277)所示。

    **图 2**  精准访问防护配置框<a name="waf_01_0010_fig275911394277"></a>  
    ![](figures/精准访问防护配置框.png "精准访问防护配置框")


1.  在列表左上角，单击“引用表管理“，如[图3](#fig4734138172818)所示。

    **图 3**  引用有管理<a name="fig4734138172818"></a>  
    ![](figures/引用有管理.png "引用有管理")

2.  在“引用表管理“界面，单击“添加引用表“，如[图4](#fig19224237165813)所示。

    **图 4**  引用表管理界面<a name="fig19224237165813"></a>  
    ![](figures/引用表管理界面.png "引用表管理界面")

3.  在弹出的“添加引用表“对话框中，添加引用表，如[图5](#fig8225337135816)所示，参数说明如[表1](#table22291637155812)所示。

    **图 5**  添加引用表<a name="fig8225337135816"></a>  
