...
6.  在弹出的“添加引用表“对话框中，添加引用表，如[图2](#fig8225337135816)所示，参数说明如[表1](#table22291637155812)所示。
    ...
    **表 1**  添加引用表参数说明
    ...
    <div class="notice" id="note159667494229"><a name="note159667494229"></a><a name="note159667494229"></a><span class="noticetitle"> 须知： </span><div class="noticebody"><p id="zh-cn_topic_0110861354_p9994853161215"><a name="zh-cn_topic_0110861354_p9994853161215"></a><a name="zh-cn_topic_0110861354_p9994853161215"></a>仅旗舰版支持IPv6。</p>
    </div></div>
