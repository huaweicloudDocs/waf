...
5.  在“地理位置访问控制“配置框中，设置“状态“为开启状态![](figures/开启图标-15.png)，单击“自定义地理位置访问控制规则“，进入“地理位置访问控制“页面，如[图2](#fig1841026151810)所示。

    **图 2**  地理位置访问控制配置框<a name="fig1841026151810"></a>  
    ![](figures/地理位置访问控制配置框.png "地理位置访问控制配置框")

6.  在“地理位置访问控制“页面左上角，单击“添加规则“，如[图3](#fig89631621191318)所示。

    **图 3**  添加规则<a name="fig89631621191318"></a>  
    ![](figures/添加规则-16.png "添加规则-16")

7.  在弹出的对话框，添加地理位置访问控制规则，如[图4](#fig49385421125519)所示，根据[表1](#table4696626918715)配置参数。
